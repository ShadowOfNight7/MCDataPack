...
execute as @s if block ~ ~ ~ spawner{SpawnCount:0s} align xyz positioned ~0.5 ~ ~0.5 unless entity @e[tag=CustomCrafter,distance=..0.5] run summon armor_stand ~ ~ ~ {Tags:["CustomCrafter","CustomCrafterInitial"],NoGravity:true}
# setblock ~ ~ ~ bedrock
