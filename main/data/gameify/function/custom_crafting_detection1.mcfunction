...
execute as @s if score @s posX matches 0 if score @s posY matches 0 if score @s posZ matches 1.. positioned ~-21 ~-21 ~1 run function gameify:custom_crafting_detection1 with entity @s
execute as @s if score @s posX matches 0 if score @s posY matches 1.. if score @s posZ matches 1.. positioned ~-21 ~1 ~ run function gameify:custom_crafting_detection1 with entity @s
