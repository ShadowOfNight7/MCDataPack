...
execute as @s at @s unless entity @e[tag=EndermanTarget] if entity @p[distance=..30,gamemode=!creative,gamemode=!spectator] run damage @s 0 magic by @p[distance=..30,gamemode=!creative,gamemode=!spectator]
