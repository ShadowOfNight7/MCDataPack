...
execute as @e[tag=CustomCrafterInitial] at @s align xyz run summon block_display ~ ~ ~ {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.01f,1.01f,1.01f]},block_state:{Name:"minecraft:crafting_table"}}
