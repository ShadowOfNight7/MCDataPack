...
execute as @e[tag=CustomCrafterInitial] at @s align xyz run summon block_display ~-0.0005 ~-0.0005 ~-0.0005 {brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.001f,1.001f,1.001f]},block_state:{Name:"minecraft:crafting_table"}}
