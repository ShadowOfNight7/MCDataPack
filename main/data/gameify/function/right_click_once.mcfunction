...
execute as @s[tag=Occultist] at @s if score @s cooldown matches ..0 if score @s shiftingCheck matches 1.. run function gameify:abilities/occultist_2 with entity @s
